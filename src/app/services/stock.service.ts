...
export class StockService {
  ...
  getStockMini() {
    return Promise.resolve(this.getStockData().slice(0, 5));
  }

  getStockSmall() {
    return Promise.resolve(this.getStockData().slice(0, 10));
  }

  getStock() {
    return Promise.resolve(this.getStockData());
  }

  getStockWithOrdersSmall() {
    return Promise.resolve(this.getStockWithOrdersData().slice(0, 10));
  }

  getStockWithOrders() {
    return Promise.resolve(this.getStockWithOrdersData());
  }
}
